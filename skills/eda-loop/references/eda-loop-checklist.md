...
Use this file only after `SKILL.md` has already determined that `eda-loop` is the right execution skill.
...
- Run `eda-preflight-reflect` before any new experiment submission/comparison batch.
